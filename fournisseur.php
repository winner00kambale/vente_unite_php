...
$rqt=$con->query('SELECT * FROM `fournisseur`');
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
         <h3>Formulaire des fournisseurs</h3>
         <div class="form-group">
          <button class="btn btn-info" data-toggle="modal" data-target="#myModal">Ajouter fournisseur</button>    
         </div>
         ...
         <table class="table table-striped table-hover table-sm table-bordered">
            <thead>
                ...
                <th style="text-align:center;background:#2E323A;color:white;">adresse</th>
                <th style="text-align:center;background:#2E323A;color:white;">nom shop</th>
                <th style="text-align:center;background:#2E323A;color:white;">telephone</th>
                <th style="text-align:center;background:#2E323A;color:white;">paremettre</th>
            </thead>
            <tbody>
               
            <?php foreach($resultat as $ligne){ ?>
            <tr>
            <td style="text-align:center;"> <?php echo($ligne['id_f']) ?> </td>
            ...
            <td style="text-align:center;"> <?php echo($ligne['adresse']) ?> </td>
            <td style="text-align:center;"> <?php echo($ligne['shop']) ?> </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="modification.php" method="POST">
                            ...
                            <input type="submit" name="modifier" value="Modifier" class="btn btn-info btn-round">
                        </form>
